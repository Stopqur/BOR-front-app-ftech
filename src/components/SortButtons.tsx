...
interface IParamsProps {
  editParams: (arg1: Object) => void;
  paramName: string;
}

const SortButtons = ({editParams, paramName}: IParamsProps) => {
  return (
    <div className='d-flex justify-content-center'>
      <Button className='sort-btn' onClick={e => editParams({sortBy: paramName, sortOrder: 'ASC'})}>
      ...
      <Button className='sort-btn' onClick={e => editParams({sortBy: paramName, sortOrder: 'DESC'})}>
