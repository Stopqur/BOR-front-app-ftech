    ...
    <div className="px-5 py-5">
      {token ? (
        <div className="d-flex justify-content-center mb-3">
          <Button variant="outline-success" className="btn-recipes" onClick={handleGetRecipes}>
            All recipes
          </Button>
          <Button variant="outline-success" className="btn-recipes" onClick={handleGetUserRecipes}>
            Your recipes
          </Button>
        </div>
      ) : null}
